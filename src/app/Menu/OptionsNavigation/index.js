...
export default function OptionsNavigation() {
  ...
  return (
    <>
      <Link onClick={hook.closeMenu} href="/">
        Inicio
      </Link>

      <Link onClick={hook.closeMenu} href="/#nosotros">
        Nosotros
      </Link>

      <Link onClick={hook.closeMenu} href={"/#servicios"}>
        Servicios
      </Link>

      <Link onClick={hook.closeMenu} href={"/#productos"}>
        Productos
      </Link>
